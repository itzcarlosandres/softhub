...
<div class="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-900 dark:to-gray-800 py-16">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">Términos y Condiciones</h1>
...
<div class="max-w-4xl mx-auto px-4 py-12">
    ...
    <div class="prose prose-lg max-w-none dark:prose-invert">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">1. Aceptación de los Términos</h2>
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">2. Uso del Servicio</h2>
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">3. Descargas de Software</h2>
            <p class="text-gray-700 dark:text-gray-300">
                El software disponible en nuestro sitio es proporcionado por terceros. No somos responsables de:
            </p>
            <ul class="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mt-4">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">4. Propiedad Intelectual</h2>
            <p class="text-gray-700 dark:text-gray-300">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">5. Limitación de Responsabilidad</h2>
            <p class="text-gray-700 dark:text-gray-300">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">7. Modificaciones</h2>
            <p class="text-gray-700 dark:text-gray-300">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">8. Contacto</h2>
            <p class="text-gray-700 dark:text-gray-300">
