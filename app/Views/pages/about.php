...
<div class="bg-gradient-to-br from-blue-50 to-cyan-50 py-16">
    <div class="max-w-4xl mx-auto px-4">
        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Acerca de Nosotros</h1>
        <p class="text-xl text-gray-600">Tu fuente confiable de software</p>
    </div>
</div>
...
<div class="max-w-4xl mx-auto px-4 py-12">
        ...
        <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-xl font-bold text-gray-900">Descargas Seguras</h3>
                </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-xl font-bold text-gray-900">Siempre Actualizado</h3>
                </div>
                <p class="text-gray-600">
            ...
            <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-xl font-bold text-gray-900">Descargas Rápidas</h3>
                </div>
                <p class="text-gray-600">
            ...
            <div class="bg-white rounded-xl p-6 shadow-md border border-gray-100">
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <h3 class="text-xl font-bold text-gray-900">Comunidad Activa</h3>
                </div>
                <p class="text-gray-600">
        ...
        <div class="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-8">
            <ul class="space-y-4">
                <li class="flex items-start gap-3">
                    ...
                    <div>
                        <strong class="text-gray-900">Transparencia:</strong>
                        <span class="text-gray-700"> Información clara sobre cada software.</span>
                    </div>
                </li>
                <li class="flex items-start gap-3">
                    <i class="fas fa-check-circle text-blue-600 text-xl mt-1"></i>
                    <div>
                        <strong class="text-gray-900">Seguridad:</strong>
                        <span class="text-gray-700"> Protección de nuestros usuarios es nuestra prioridad.</span>
                    </div>
                </li>
                <li class="flex items-start gap-3">
                    <i class="fas fa-check-circle text-blue-600 text-xl mt-1"></i>
                    <div>
                        <strong class="text-gray-900">Calidad:</strong>
                        <span class="text-gray-700"> Solo el mejor software en nuestro catálogo.</span>
                    </div>
                </li>
                <li class="flex items-start gap-3">
                    <i class="fas fa-check-circle text-blue-600 text-xl mt-1"></i>
                    <div>
                        <strong class="text-gray-900">Innovación:</strong>
                        <span class="text-gray-700"> Mejoramos constantemente nuestra plataforma.</span>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <!-- Contacto -->
    <section class="bg-white rounded-xl p-8 shadow-md border border-gray-100">
        <h2 class="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
        ...
        <div class="flex flex-col md:flex-row gap-4">
            <a href="mailto:contacto@<?= $_SERVER['HTTP_HOST'] ?>" 
               class="flex items-center gap-3 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold">
                <i class="fas fa-envelope"></i>
                Enviar Email
            </a>
            <a href="<?= url() ?>" 
               class="flex items-center gap-3 px-6 py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-semibold">
