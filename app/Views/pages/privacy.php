...
<div class="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-900 dark:to-gray-800 py-16">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <h1 class="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4">Política de Privacidad</h1>
...
<div class="max-w-4xl mx-auto px-4 py-12">
    ...
    <div class="prose prose-lg max-w-none dark:prose-invert">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">1. Información que Recopilamos</h2>
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">2. Cómo Usamos tu Información</h2>
            <p class="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">3. Cookies</h2>
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">4. Compartir Información</h2>
            <p class="text-gray-700 dark:text-gray-300 mb-4">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">5. Seguridad</h2>
            <p class="text-gray-700 dark:text-gray-300">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">6. Enlaces a Terceros</h2>
            <p class="text-gray-700 dark:text-gray-300">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">7. Tus Derechos</h2>
            <p class="text-gray-700 dark:text-gray-300 mb-4">
                Tienes derecho a:
            </p>
            <ul class="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">8. Menores de Edad</h2>
            <p class="text-gray-700 dark:text-gray-300">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">9. Cambios a esta Política</h2>
            <p class="text-gray-700 dark:text-gray-300">
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">10. Contacto</h2>
            <p class="text-gray-700 dark:text-gray-300">
